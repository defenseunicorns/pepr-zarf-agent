...
interface IImageTransformService
...
interface IImageTransformService_IImageTransformHost
  extends grpc.MethodDefinition<
    image_pb.TransformRequest,
    image_pb.TransformResponse
  > {
...
interface IImageTransformService_IImageTransformHostWithoutChecksum
  extends grpc.MethodDefinition<
    image_pb.TransformRequest,
    image_pb.TransformResponse
  > {
...
export interface IImageTransformServer
  extends grpc.UntypedServiceImplementation {
  imageTransformHost: grpc.handleUnaryCall<
    image_pb.TransformRequest,
    image_pb.TransformResponse
  >;
  imageTransformHostWithoutChecksum: grpc.handleUnaryCall<
    image_pb.TransformRequest,
    image_pb.TransformResponse
  >;
}
...
export class ImageTransformClient
  extends grpc.Client
  implements IImageTransformClient
{
  constructor(
    address: string,
